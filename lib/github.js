...
const createPullRequest = async () => {
    ...
    if (isBranch(githubOptions.ref)) {
        ...
        try {
            ...
            const pullRequestResult = createPullRequestResult(JSON.parse(result.body));
            await assignActorToPullRequest(pullRequestResult.number, githubOptions);
...
const assignActorToPullRequest = async (pullRequestId, githubOptions) => {
